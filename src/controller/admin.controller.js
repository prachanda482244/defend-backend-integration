...
const updateApproval = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, report, "Report has been approved/rejected"));
});
...
const bulkDelete = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "All entries deleted successfully"));
});
...
const getSingleReport = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, report, "Single Report data"));
});
